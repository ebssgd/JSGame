    ...
    class Egg {
        ...
        draw(context){
            ...
            if(this.game.debug){
                ...
                context.fillText(displayTimer, this.collisionX, this.collisionY - this.collisionRadius * 2.4);
            }
        }
    ...
    class Game {
        ...
        render(context, deltaTime){
            if(this.timer > this.interval){
                ...
                //proper vertical order to give illusion of 3d
